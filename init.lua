...
require('lazy').setup({
  ...
  { -- Catppuccin colorscheme - soothing pastel theme
    'catppuccin/nvim',
    name = 'catppuccin',
    ...
    config = function()
      require('catppuccin').setup {
        ...
        no_italic = true, -- Disable italics to match your previous config
        no_bold = false,
        no_underline = false,
        styles = {
          comments = {}, -- No italic for comments (matching your tokyonight config)
          conditionals = {},
          loops = {},
          functions = {},
          keywords = {},
